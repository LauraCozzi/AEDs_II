...
public class Questao7 {
    ...
    public static void main(String [] args) throws Exception{
        ...
        for(String nomePersonagem = sc.nextLine(); nomePersonagem.equals("FIM") == false; nomePersonagem = sc.nextLine()){
            pertence = lista.pesquisar(nomePersonagem);
            if(pertence)System.out.println("SIM");
