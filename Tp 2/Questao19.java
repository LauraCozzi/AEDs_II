...
public class Questao19 {
     ...
     */
        ...
        void swap(int i, int j, Arquivo log) {
            Personagem temp = array[i];
            array[i] = array[j];
            array[j] = temp;

            log.numMovimentacoes += 3;
        ...
        public static class Arquivo {
            ...
            public void criarLog(String nomeArquivo, long tempo){  //Funcao para criar o log em arquivo
                
                try{
                    
                    FileWriter escreverArq = new FileWriter(nomeArquivo);
                    
                    escreverArq.write("650972\t" + tempo + "\t" + this.numComparacoes + "\t" + this.numMovimentacoes);
                    escreverArq.close();
        
                }catch(Exception error){
                    System.out.println("Erro ou criar o arquivo de log!");
                }
            }
    ...
    public static void main(String [] args) throws Exception{
        ...
        log.criarLog("matrícula_selecao.txt", tempo);
